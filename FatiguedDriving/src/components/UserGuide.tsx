            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">疲劳度 &lt; 30%，状态良好</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 bg-yellow-50 rounded-lg">
                ...
                <div>
                  <div className="text-sm">疲劳预警</div>
                  <div className="text-xs text-muted-foreground">疲劳度 30-70%，建议注意休息</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 bg-red-50 rounded-lg">
                ...
                <div>
                  <div className="text-sm">危险警报</div>
                  <div className="text-xs text-muted-foreground">疲劳度 &gt; 70%，请立即停车休息</div>
                </div>
              </div>
            </div>
          </div>
