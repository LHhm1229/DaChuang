...
import { Bluetooth, Wifi, WifiOff, CheckCircle, AlertCircle, XCircle, Activity, Clock, Settings, Trash2, BarChart3 } from 'lucide-react';
import { bluetoothService, BluetoothDryEyeData } from '../services/bluetoothService';

interface BluetoothControlProps {
  onDataReceived: (data: BluetoothDryEyeData) => void;
}
...
export function BluetoothControl({ onDataReceived }: BluetoothControlProps) {
  ...
  const handleDataReceived = (data: BluetoothDryEyeData) => {
        ...
        <div className="mt-4 space-y-4">
          ...
          <Card className="p-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h4 className="text-sm font-medium">数据接收提示</h4>
            </div>
