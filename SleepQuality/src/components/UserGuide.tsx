          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <ol className="space-y-2 text-sm list-decimal list-inside">
                ...
                <li>关注睡眠阶段时间轴，查看 REM、浅睡和深睡变化</li>
                <li>注意警报提示，及时响应睡眠质量警告</li>
                <li>睡眠结束后点击"停止监控"</li>
                <li>查看睡眠报告和历史数据</li>
              </ol>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                ...
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">睡眠质量 &gt; 70%，状态良好</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 bg-yellow-50 rounded-lg">
                ...
                <div>
                  <div className="text-sm">睡眠预警</div>
                  <div className="text-xs text-muted-foreground">睡眠质量 30-70%，建议改善睡眠环境</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-3 bg-red-50 rounded-lg">
                ...
                <div>
                  <div className="text-sm">睡眠质量差</div>
                  <div className="text-xs text-muted-foreground">睡眠质量 &lt; 30%，请调整睡眠习惯</div>
                </div>
              </div>
            </div>
          </div>
